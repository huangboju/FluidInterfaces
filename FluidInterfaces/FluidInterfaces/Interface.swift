...
extension Interface {
    ...
    public static var all: [[Interface]] {
        return [
            ...
            [
            Interface(name: "AnimatedWaveView", icon: #imageLiteral(resourceName: "icon_rotation"), color: UIColor(hex: 0xFF28A5), type: AnimatedWaveViewVC.self),
            Interface(name: "AppleWatchBreathe", icon: #imageLiteral(resourceName: "icon_rotation"), color: UIColor(hex: 0xFF28A5), type: AppleWatchBreatheVC.self),
            ]
        ]
    }
